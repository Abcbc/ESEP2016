...
public:
	...
	//LIGHT BARRIERS
		...
		virtual void TRAFFIC_NEW_PUK(void){};
		virtual void TRAFFIC_NEW_PUK_OUT(void){};
		...
		virtual void TIMER_HEIGHT_MEASURE_TO_SWITCH_OUT(void){};
		virtual void TIMER_HEIGHT_MEASURE_TO_RAMP_OUT(void){};
		...
		virtual void TIMER_SWITCH_TO_EXIT_OUT(void){};
		virtual void TIMER_NEW_PUK_OUT(void){};
		virtual void TIMER_HEIGHT_MEASURE_DURATION_OUT(void){};
		virtual void TIMER_TRANSMIT_OUT(void){};
		virtual void TIMER_CREATE_PUK_OUT(void){};

		// Errors
		virtual void ERR_LOST_PUK(void){};
		virtual void ERR_TO_MANY_PUK(void){};
		virtual void ERR_PUK_TOO_EARLY(void){};
		virtual void ERR_PUK_TOO_EARLY_OK(void){};
