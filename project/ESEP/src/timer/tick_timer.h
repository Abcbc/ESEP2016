...
#define HEIGHT_MEASURE_DURATION 6200
#define HEIGHT_MEASURE_TO_SWITCH_DURATION 4000
#define HEIGHT_MEASURE_TO_RAMP_DURATION 5000
#define SWITCH_TO_EXIT_DURATION 5400
#define SWITCH_OPEN_DURATION 4000
#define SWITCH_OPEN_LONG_DURATION 10000
