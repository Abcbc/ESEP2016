...
const unsigned int HEIGHT_SENSOR_MEASURE_START_E_ID = TYPE_PUK_SWITCH + 1;
const unsigned int HEIGHT_SENSOR_MEASURE_FINISHED_E_ID = TYPE_PUK_SWITCH + 2;

const unsigned int HEIGHT_SENSOR_INDENTIFIED_BARCODE_PUK_E_ID = TYPE_PUK_SWITCH + 3;
const unsigned int HEIGHT_SENSOR_INDENTIFIED_NORMAL_PUK_E_ID = TYPE_PUK_SWITCH + 4;
const unsigned int HEIGHT_SENSOR_INDENTIFIED_HOLE_PUK_E_ID = TYPE_PUK_SWITCH + 5;
const unsigned int HEIGHT_SENSOR_INDENTIFIED_METAL_PUK_E_ID = TYPE_PUK_SWITCH + 6;
